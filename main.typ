...
We also mention that $LogicGrz$ has been mechanized in HOL Light by Bilotta, Maggesi, and Perini Brogi as part of the HOLMS project @BMPB26a.
...
As far as we know, the only mechanizations of the proof theory of sequent calculi equipped with such additional machinery are the mechanization of the labelled sequent calculus in HOL Light by Maggesi and Perini Brogi @MPB21 @MPB23 and, along that line, Bilotta's HOLMS project @Bil25 @BMPB26a.
